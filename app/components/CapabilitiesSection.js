...
const capabilities = [
  {
    ...
    meta: ["REGULATORY SAFETY", "VERIFIED MARKET DATA", "COMPLIANCE-FIRST"],
  },
  {
    ...
    meta: ["DISCLOSURE AUTOMATION", "REAL-TIME ANALYSIS", "ZERO-FRICTION"],
  },
  {
    ...
    meta: ["PERSONALIZED SIGNALS", "RISK MANAGEMENT", "DATA-DRIVEN"],
  },
];
...
export default function CapabilitiesSection({ children }) {
  ...
  return (
    <section className="capabilities-section" id="services">
        ...
        {capabilities.map((item, index) => (
          ...
          >
            ...
            <div className="capability-row__content">
              ...
              <footer>{item.meta.map((label) => <span key={label}>{label}</span>)}</footer>
            </div>
            <div
      ...
      <div className="strengths-section" ref={strengthsRef} data-scroll-cursor="down" data-nav-theme="light">
