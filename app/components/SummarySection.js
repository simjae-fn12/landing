...
export default function SummarySection() {
  return (
    <section className="summary-section" id="vision" data-scroll-cursor="down" data-nav-theme="light">
      <header className="summary-section__header">
        <p>CLOUD-NATIVE FOUNDATION</p>
      </header>
        ...
        <div className="summary-section__statement">
          ...
          <p>
            ...
            <span>
              ...
              사용자 중심의 거래 경험과 대한민국 차세대 테크 증권사의 표준을 증명합니다.
            </span>
          </p>
        </div>
